<template>
  ...
  <div
    id="userDropdown"
    class="z-10 hidden absolute top-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600 mt-2 right-0 sm:right-auto"
  >
